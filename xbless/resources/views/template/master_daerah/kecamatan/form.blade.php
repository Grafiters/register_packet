    ...
    <div class="col-lg-10">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">
                <strong>{{isset($kecamatan) ? 'Edit' : 'Tambah'}} @yield('title')</strong>
            </li>
        </ol>
    </div>
    <div class="col-lg-2">
        <br />
        <a href="{{ route('master.kecamatan.index') }}"
        ...
        <div class="col-lg-12">
            <div class="ibox ">
                <div class="ibox-title">
                    ...
                    @endif
                    <h5>{{isset($kecamatan) ? 'Edit' : 'Tambah'}} @yield('title')</h5>
                </div>
                <div class="ibox-content">
                    <form id="submitData">
                        <input type="hidden" name="_token" value="{{ csrf_token() }}">
                        <input type="hidden" name="enc_id" id="enc_id" value="{{isset($kecamatan)? $enc_id : ''}}">
                        <div class="form-group row px-4"><label class="col-sm-3 col-form-label">Kabupaten</label>
                            <div class="col-sm-9">
                                <div class="input-group ">
                                    <select id="kabupaten" class="form-control chosen-select" name="kabupaten"
                                        @can('kabupaten.index') disabled @endcan>
                                        <option disabled selected value="">
                                            Pilih Kabupaten</option>
                        ...
                        <div class="form-group row px-4">
                            ...
                            <div class="col-sm-9">
                                <div class="input-group error-text">
                                    <input type="text" class="form-control py-2" id="id" name="id"
                                        value="{{isset($kecamatan)? $kecamatan->id : ''}}">
                                </div>
                            </div>
                        </div>
                        <div class="form-group row px-4">
                            ...
                            <div class="col-sm-9">
                                <div class="input-group error-text">
                                    <input type="text" class="form-control py-2" id="name" name="name"
                                        value="{{isset($kecamatan)? $kecamatan->name : ''}}">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group row ">
                            <div class="col-sm-4 col-sm-offset-2">
                                <a class="btn btn-white btn-sm" href="{{route('master.kecamatan.index')}}">Batal</a>
...
<script>
    $(document).ready(function () {
        ...
        function SimpanData(){
            ...
            $.ajax({
                type: 'POST',
                url : "{{route('master.kecamatan.simpan')}}",
                ...
                success: function(data){
                    if (data.success) {
                        ...
                        window.location.replace('{{route("master.kecamatan.index")}}');
                    } else {
