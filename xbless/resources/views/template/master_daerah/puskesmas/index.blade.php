        ...
        <div class="col-lg-12">
            <div class="ibox">
                <div class="ibox-content p-5">
                    <div class="d-flex">
                        <a href="{{ route('master.puskesmas.tambah')}}" class="btn btn-success rounded-0"> Tambah </a>
                        ...
                        <table id="table1" class="table p-0">
                            <thead>
                                <tr>
                                    ...
                                    <th>Kecamatan</th>
                                    <th>Code Puskesmas</th>
                                    <th>Name Puskesmas</th>
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        table = $('#table1').DataTable({
            ...
            "select" : true,
            "ajax":{
                     "url": "{{ route("master.puskesmas.getdata") }}",
                     "dataType": "json",
                     "type": "POST",
                     data: function ( d ) {
                       d._token= "{{csrf_token()}}";
