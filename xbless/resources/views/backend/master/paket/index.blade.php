        ...
        <div class="col-lg-12">
            <div class="ibox">
                <div class="ibox-content p-5">
                    <div class="d-flex">
                        <a href="{{ route('admin.master.kategori.paket.tambah')}}" class="btn btn-success rounded-0"> Tambah </a>
                    </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        table = $('#table1').DataTable({
            ...
            "select" : true,
            "ajax":{
                     "url": "{{ route("admin.master.kategori.paket.getdata") }}",
                     "dataType": "json",
                     "type": "POST",
                     data: function ( d ) {
                       d._token= "{{csrf_token()}}";
    ...
    function deleteData(e,enc_id){
        ...
        Swal.fire({
            ...
            if (result.value) {
                ...
                $.ajax({
                    type: 'delete',
                    url: '{{route("admin.master.kategori.paket.hapus",[null])}}/' + enc_id,
