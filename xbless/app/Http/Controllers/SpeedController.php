...
class SpeedController extends Controller
{
    ...
    public function index(){
        return view('backend/master/speed/index');
    }
    ...
    public function getdata(Request $request){
        ...
        foreach ($data as $key=> $result){
            ...
            $action.='<a href="'.route('admin.master.kategori.speed.ubah', $enc_id).'" class="btn btn-warning btn-xs icon-btn md-btn-flat product-tooltip" title="Edit"><i class="fa fa-pencil"></i> Edit</a>&nbsp;';
    ...
    public function tambah(){
        return view('backend/master/speed/form');
    }
    ...
    public function simpan(Request $request){
        ...
        $check_name = $this->cekExist('speeds','name', $request->name, $dec_id);
    ...
    public function edit($enc_id){
        ...
        $data = Speed::find($dec_id);
        if(!$data){
            return $this->nodata('Data Kecepatan Jaringan tidak ditemukan');
        }

        return view('backend/master/speed/form', compact('enc_id','data'));
    ...
    public function delete($enc_id){
        ...
        $paket_detail = $this->cekExist('detail_pakets','speed_id', $dec_id, NULL);
        if(!$paket_detail){
